...
CONFIG.PCW_MIO_TREE_PERIPHERALS {unassigned#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#unassigned#unassigned#Timer 0#Timer 0#unassigned#unassigned#unassigned#unassigned#UART 1#UART 1#unassigned#unassigned#Enet 0#Enet 0} \
CONFIG.PCW_MIO_TREE_SIGNALS {unassigned#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#unassigned#unassigned#wave_out#clk_in#unassigned#unassigned#unassigned#unassigned#tx#rx#unassigned#unassigned#mdc#mdio} \
...
CONFIG.PCW_TTC0_TTC0_IO {MIO 42 .. 43} \
...
CONFIG.CONST_WIDTH {6} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_dispctrl_0/S_AXI] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  ...
  connect_bd_net -net axi_dispctrl_0_PXL_CLK_O [get_bd_pins axi_dispctrl_0/PXL_CLK_O] [get_bd_pins axi_dispctrl_0/s_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_dispctrl_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins axi_dispctrl_0/s_axis_mm2s_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dispctrl_0/REF_CLK_I] [get_bd_pins axi_dispctrl_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
...
preplace port vga_hs -pg 1 -y 540 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 90 -defaultsOSRD
preplace port vga_vs -pg 1 -y 560 -defaultsOSRD
preplace portBus vga_b -pg 1 -y 640 -defaultsOSRD
preplace portBus vga_r -pg 1 -y 600 -defaultsOSRD
...
preplace inst axi_dispctrl_0 -pg 1 -lvl 5 -y 560 -defaultsOSRD
preplace inst proc_sys_reset_1 -pg 1 -lvl 4 -y 650 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 2 -y 390 -defaultsOSRD
preplace inst axi_interconnect_1 -pg 1 -lvl 4 -y 110 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -y 120 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 5 1 NJ
preplace netloc axi_dispctrl_0_PXL_CLK_O 1 2 4 740 560 1160 560 1560 710 2030
preplace netloc axi_vdma_0_M_AXIS_MM2S 1 3 2 N 340 NJ
preplace netloc proc_sys_reset_1_peripheral_aresetn 1 4 1 1590
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 30 540 NJ 540 NJ 540 1190 370 NJ 370 2030
preplace netloc axi_vdma_0_m_axis_mm2s_tkeep 1 3 2 N 360 NJ
preplace netloc proc_sys_reset_0_interconnect_aresetn 1 1 3 390 90 NJ 90 N
preplace netloc xlconstant_0_dout 1 2 1 NJ
preplace netloc axi_dispctrl_0_GREEN_O 1 5 1 NJ
preplace netloc S00_AXI_1 1 1 5 400 230 NJ 230 NJ 230 NJ 230 2040
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ
preplace netloc axi_dispctrl_0_FSYNC_O 1 2 4 750 470 NJ 410 NJ 410 2040
preplace netloc axi_vdma_0_mm2s_introut 1 3 2 NJ 250 1570
preplace netloc S00_AXI_2 1 3 1 1150
preplace netloc axi_interconnect_0_M00_AXI 1 2 3 710 480 NJ 480 NJ
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 1 4 370 530 720 490 1170 490 NJ
preplace netloc axi_dispctrl_0_VSYNC_O 1 5 1 NJ
preplace netloc axi_dispctrl_0_HSYNC_O 1 5 1 NJ
preplace netloc axi_interconnect_0_M01_AXI 1 2 1 700
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 20 250 380 250 750 240 1160 240 1600 20 2050
preplace netloc axi_interconnect_1_M00_AXI 1 4 1 1570
preplace netloc axi_dispctrl_0_BLUE_O 1 5 1 NJ
preplace netloc axi_dispctrl_0_RED_O 1 5 1 NJ
levelinfo -pg 1 0 200 550 950 1390 1820 2070 -top 0 -bot 740
",
}
