...
proc create_root_design { parentCell } {
  ...
  set MIC_SPI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:spi_rtl:1.0 MIC_SPI ]
  ...
  set AC_SDATA_I [ create_bd_port -dir I -type data AC_SDATA_I ]
...
CONFIG.PCW_MIO_TREE_PERIPHERALS {unassigned#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Timer 0#Timer 0#unassigned#unassigned#unassigned#unassigned#UART 1#UART 1#unassigned#unassigned#Enet 0#Enet 0} \
CONFIG.PCW_MIO_TREE_SIGNALS {unassigned#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#wave_out#clk_in#unassigned#unassigned#unassigned#unassigned#tx#rx#unassigned#unassigned#mdc#mdio} \
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_SPI_0 [get_bd_intf_ports MIC_SPI] [get_bd_intf_pins processing_system7_0/SPI_0]
  ...
  connect_bd_net -net util_reduced_logic_1_Res [get_bd_ports AC_PBLRC] [get_bd_ports AC_RELRC] [get_bd_pins axi_i2s_adi_0/LRCLK_O]
...
preplace port AC_MCLK -pg 1 -y 230 -defaultsOSRD
preplace port AC_MUTE_N -pg 1 -y 340 -defaultsOSRD
...
preplace port MIC_SPI -pg 1 -y 130 -defaultsOSRD
preplace portBus AC_SDATA_O -pg 1 -y 320 -defaultsOSRD
preplace portBus AC_PBLRC -pg 1 -y 280 -defaultsOSRD
preplace portBus AC_RELRC -pg 1 -y 300 -defaultsOSRD
preplace portBus AC_BCLK -pg 1 -y 20 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 1 -y 300 -defaultsOSRD
preplace inst axi_i2s_adi_0 -pg 1 -lvl 3 -y 190 -defaultsOSRD
...
preplace netloc axi_i2s_adi_0_DMA_RX_REQ 1 3 1 1060
preplace netloc AC_SDATA_I_1 1 0 3 NJ 130 NJ 130 NJ
preplace netloc util_reduced_logic_1_Res 1 3 2 NJ 310 NJ
preplace netloc axi_i2s_adi_0_DMA_TX_REQ 1 3 1 1040
preplace netloc ARESETN_1 1 1 1 360
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 5 20 400 NJ 400 NJ 400 NJ 400 1460
preplace netloc processing_system7_0_IIC_0 1 4 1 NJ
preplace netloc axi_i2s_adi_0_SDATA_O 1 3 2 NJ 320 NJ
preplace netloc processing_system7_0_DMA0_ACK 1 2 3 720 340 NJ 340 1490
preplace netloc processing_system7_0_DMA1_ACK 1 2 3 730 350 NJ 350 1480
preplace netloc axi_i2s_adi_0_BCLK_O 1 3 2 NJ 20 NJ
preplace netloc processing_system7_0_FIXED_IO 1 4 1 NJ
preplace netloc S00_AXI_1 1 1 4 390 380 NJ 380 NJ 380 1470
preplace netloc axi_i2s_adi_0_MUTEN_O 1 3 2 NJ 330 NJ
preplace netloc axi_interconnect_0_M00_AXI 1 2 1 690
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 1 2 380 390 710
preplace netloc processing_system7_0_FCLK_CLK0 1 0 5 20 210 370 370 700 370 1070 300 1450
preplace netloc processing_system7_0_SPI_0 1 4 1 NJ
preplace netloc processing_system7_0_FCLK_CLK2 1 2 3 740 360 NJ 360 1510
levelinfo -pg 1 0 190 540 890 1260 1540 -top 0 -bot 410
",
}
