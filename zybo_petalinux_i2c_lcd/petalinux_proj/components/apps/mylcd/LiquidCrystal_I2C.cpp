...
// CONSTRUCTORS
// ---------------------------------------------------------------------------
LiquidCrystal_I2C::LiquidCrystal_I2C(linuxi2c& i2cobj, uint8_t lcd_Addr ) : _i2cio( i2cobj )
{
   config(lcd_Addr, EN, RW, RS, D4, D5, D6, D7);
}


LiquidCrystal_I2C::LiquidCrystal_I2C(linuxi2c& i2cobj, uint8_t lcd_Addr, uint8_t backlighPin, 
                                     t_backlighPol pol = POSITIVE) : _i2cio( i2cobj )
{
   config(lcd_Addr, EN, RW, RS, D4, D5, D6, D7);
   setBacklightPin(backlighPin, pol);
}

LiquidCrystal_I2C::LiquidCrystal_I2C(linuxi2c& i2cobj, uint8_t lcd_Addr, uint8_t En, uint8_t Rw,
                                     uint8_t Rs) : _i2cio( i2cobj )
{
   config(lcd_Addr, En, Rw, Rs, D4, D5, D6, D7);
}
...
LiquidCrystal_I2C::LiquidCrystal_I2C(linuxi2c& i2cobj, uint8_t lcd_Addr, uint8_t En, uint8_t Rw,
                                     ...
                                     uint8_t d6, uint8_t d7 ) : _i2cio( i2cobj )
{
   config(lcd_Addr, En, Rw, Rs, d4, d5, d6, d7);
}
