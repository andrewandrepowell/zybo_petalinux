...
set_property IOSTANDARD LVCMOS33 [get_ports {i2c_lcd_scl_io}]
set_property PULLUP TRUE [get_ports {i2c_lcd_scl_io}]

#IO_L19P_T3_35
set_property PACKAGE_PIN H15 [get_ports {i2c_lcd_sda_io}]
set_property IOSTANDARD LVCMOS33 [get_ports {i2c_lcd_sda_io}]
set_property PULLUP TRUE [get_ports {i2c_lcd_sda_io}]
