...
HD_PWD='/opt/Xilinx/Projects/zybo_petalinux_i2c_lcd/zybo_petalinux_i2c_lcd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source block_design_wrapper.tcl -notrace
