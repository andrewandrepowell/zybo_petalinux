...
HD_PWD='/opt/Xilinx/Projects/zybo_petalinux_i2c_lcd/zybo_petalinux_i2c_lcd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source block_design_wrapper.tcl
