...
set_property IOSTANDARD LVCMOS33 [get_ports {pbs[0]}]

#IO_L24N_T3_34
set_property PACKAGE_PIN P16 [get_ports {pbs[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pbs[1]}]

#IO_L18P_T2_34
set_property PACKAGE_PIN V16 [get_ports {pbs[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pbs[2]}]

#IO_L7P_T1_34
set_property PACKAGE_PIN Y16 [get_ports {pbs[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pbs[3]}]
