...
proc create_root_design { parentCell } {
  ...
  set pbs [ create_bd_port -dir I -from 3 -to 0 -type data pbs ]
  set sws [ create_bd_port -dir I -from 3 -to 0 -type data sws ]
...
CONFIG.PCW_MIO_19_DIRECTION {in} \
...
CONFIG.PCW_MIO_TREE_PERIPHERALS {unassigned#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Timer 0#Timer 0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#UART 1#UART 1#unassigned#unassigned#unassigned#unassigned} \
CONFIG.PCW_MIO_TREE_SIGNALS {unassigned#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#wave_out#clk_in#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#tx#rx#unassigned#unassigned#unassigned#unassigned} \
...
CONFIG.NUM_PORTS {3} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_gpio_io/S_AXI] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  ...
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins axi_gpio_io/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net axi_gpio_io_gpio_io_o [get_bd_ports leds] [get_bd_pins axi_gpio_io/gpio_io_o]
  connect_bd_net -net axi_gpio_io_ip2intc_irpt [get_bd_pins axi_gpio_io/ip2intc_irpt] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net pbs_1 [get_bd_ports pbs] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_io/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net sws_1 [get_bd_ports sws] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_gpio_io/gpio2_io_i] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconcat_0/In2] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_io/S_AXI/Reg] SEG_axi_gpio_io_Reg
...
preplace portBus leds -pg 1 -y 110 -defaultsOSRD
preplace portBus sws -pg 1 -y 440 -defaultsOSRD
preplace portBus pbs -pg 1 -y 420 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 1 -y 490 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 2 -y 100 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 2 -y 440 -defaultsOSRD
preplace inst axi_gpio_io -pg 1 -lvl 4 -y 130 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 3 -y 110 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -y 280 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 2 3 NJ 240 NJ 240 NJ
preplace netloc axi_gpio_io_ip2intc_irpt 1 1 4 180 510 NJ 510 NJ 510 1160
preplace netloc processing_system7_0_M_AXI_GP0 1 2 1 570
preplace netloc ARESETN_1 1 2 1 580
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 2 170 370 570
preplace netloc pbs_1 1 0 2 NJ 420 NJ
preplace netloc axi_gpio_io_gpio_io_o 1 4 1 NJ
preplace netloc sws_1 1 0 2 NJ 440 NJ
preplace netloc xlconstant_0_dout 1 1 1 NJ
preplace netloc xlconcat_0_dout 1 2 3 NJ 440 NJ 440 1170
preplace netloc processing_system7_0_FIXED_IO 1 2 3 NJ 260 NJ 260 NJ
preplace netloc axi_interconnect_0_M00_AXI 1 3 1 N
preplace netloc processing_system7_0_FCLK_CLK0 1 1 3 160 10 560 250 890
preplace netloc S00_ARESETN_1 1 2 2 580 230 NJ
levelinfo -pg 1 0 90 370 740 1030 1190 -top 0 -bot 540
",
}
